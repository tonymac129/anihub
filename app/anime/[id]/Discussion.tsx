  ...
  return (
    <div className="flex flex-col gap-y-5">
      ...
      <h2 className="font-bold text-lg">
        Comment{anime?.comments?.length === 1 ? "" : "s"} (
        {anime?._count.comments || 0})
      </h2>
      ...
      {!full && anime && anime._count.comments > 3 && (
        <Link
          href="?tab=discussion"
          className="rounded-lg border-2 border-zinc-800 px-4 py-2 hover:bg-zinc-900 w-fit"
        >
          See full discussion
        </Link>
      )}
